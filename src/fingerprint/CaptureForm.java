...
//        Refresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Actions-view-refresh-icon.png")));
        Refresh.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                status.setText("SCAN USER RIGHT or THUMB finger for verification!!!!!");
//                if (var.getFing() == 1) {
                    prompt.setText("SCAN the USER THUMB or Index Finger for Verification.");
//                } else {
//                    prompt.setText("Scan the Voters RIGHT Index Finger here.");
//                }
...
//        if (Main.tabg != 1) {
    ...
    protected void start() {
        ...
        if(var.getFing()==1){
                    prompt.setText("SCAN the USER RIGHT THUMB here.");
                }else{
                    prompt.setText("SCAN the USER RIGHT Index Finger here.");
                }
    }
